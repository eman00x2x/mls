						...
						<div class="d-none d-md-flex">
							...
							<div class="nav-item dropdown">
								...
								<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
									<?php if(isset($_SESSION['permissions']['account']['access'])) { ?>
										<a href="<?php echo url("AccountsController@index",["id" => $_SESSION['account_id']]); ?>" class="dropdown-item"><i class='ti ti-user-circle me-2'></i> My Account</a>
									<?php } ?>
