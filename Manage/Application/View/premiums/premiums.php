...
$html[] = "<div class='page-body'>";
	$html[] = "<div class='container-xl'>";
							...
							$html[] = "<div class='mx-2 mb-3' style='width:300px; white-space: wrap;'>";
								$html[] = "<div class='card card-md text-dark ".($data['premiums']['package'][$i]['name'] == "Silver Package" ? "bg-success-lt" : "")."'>";
									...
									$html[] = "<div class='card-body text-center'>";
										...
										if(CONFIG['payment_gateway']['paypal'] == 1 || CONFIG['payment_gateway']['xendit'] == 1) {
		...
		if(isset($data['premiums']['add-on']) && $data['premiums']['add-on']) {
			$html[] = "<h3 class='text-center'>Available Add-On</h3>";
			$html[] = "<div class='mb-5' style='overflow:auto; white-space: nowrap;'>";
				$html[] = "<div class='d-flex flex-row flex-wrap justify-content-center '>";
					
					for($i=0; $i<count($data['premiums']['add-on']); $i++) {
						...
						$html[] = "<div class='mx-2 mb-3' style='width:300px; white-space: wrap;'>";
							$html[] = "<div class='card card-md'>";
								...
								$html[] = "<div class='card-body text-center'>";
									$html[] = "<div class='' style='min-height:50px; height:150px;'>";
										$html[] = "<div class='text-muted fw-medium'>".$data['premiums']['add-on'][$i]['name']."</div>";
										$html[] = "<div class='display-5 fw-bold my-3'>&#8369;".$data['premiums']['add-on'][$i]['cost']."</div>";
										$html[] = "<ul class='list-unstyled lh-lg'>";
											foreach(explode(",", $data['premiums']['add-on'][$i]['details']) as $details) {
												$html[] = "<li>$details</li>";
											}
										$html[] = "<ul>";
									$html[] = "</div>";
									...
									if(CONFIG['payment_gateway']['paypal'] == 1 || CONFIG['payment_gateway']['xendit'] == 1) {
										$html[] = "<div class='text-center mt-4'>";
											$html[] = "<a href='".url("TransactionsController@mycart", ["premium_id" => $data['premiums']['add-on'][$i]['premium_id']])."' class='btn w-100'>Subscribe</a>";
										$html[] = "</div>";
									}
