                        ...
                        $html[] = "<div class='btn-list'>";
                            ...
                            $html[] = "<div class='btn-group dropstart'>";
                                ...
                                $html[] = "<ul class='dropdown-menu' aria-labelledby='transactionDropdownFilter'>";
                                    $html[] = "<li><a class='dropdown-item' href='".url("TransactionsController@transactions", $data['account']['account_id'], ["date" => "today"])."'>Today</a></li></li>";
                                    $html[] = "<li><a class='dropdown-item' href='".url("TransactionsController@transactions", $data['account']['account_id'], ["date" => "this-week"])."'>This Week</a></li></li>";
                                    $html[] = "<li><a class='dropdown-item' href='".url("TransactionsController@transactions", $data['account']['account_id'], ["date" => "this-month"])."'>This Month</a></li></li>";
                                    $html[] = "<li><a class='dropdown-item' href='".url("TransactionsController@transactions", $data['account']['account_id'], ["date" => "this-year"])."'>This Year</a></li></li>";
                                    $html[] = "<li><hr class='dropdown-divider'></li>";
                                    $html[] = "<li><a class='dropdown-item' href='".url("TransactionsController@transactions", $data['account']['account_id'], ["date" => "last-7-days"])."'>Last 7 Days</a></li></li>";
                                    $html[] = "<li><a class='dropdown-item' href='".url("TransactionsController@transactions", $data['account']['account_id'], ["date" => "last-month"])."'>Last Month</a></li></li>";
                                    $html[] = "<li><a class='dropdown-item' href='".url("TransactionsController@transactions", $data['account']['account_id'], ["date" => "last-year"])."'>Last Year</a></li></li>";
                                $html[] = "</ul>";
                            $html[] = "</div>";
                        $html[] = "</div>";
