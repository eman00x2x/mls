...
$html[] = "<div class='offcanvas offcanvas-end' tabindex='-1' id='filterOffcanvasEnd' aria-labelledby='offcanvasEndLabel' aria-modal='true' role='dialog'>";

	$html[] = "<div class='p-4  overflow-auto'>";
		$html[] = "<form id='filter-form'>";
			...
			$html[] = "<div class='btn-filter-container sticky-bottom'>";
				$html[] = "<div class='pb-3' style='background-color: #FFF; margin-bottom: -10px;'>";
			...
			$html[] = "<div class='col-auto ms-auto d-print-none'>";
				$html[] = "<div class='d-sm-inline'>";
					$html[] = "<div class='btn-list'>";
						$html[] = "<button class='btn btn-dark dropdown-toggle' type='button' id='listingsOption' data-bs-toggle='dropdown' aria-expanded='false'><i class='ti ti-dots-circle-horizontal me-1'></i> Options</button>";
						$html[] = "<ul class='dropdown-menu' aria-labelledby='listingsOption'>";
							$html[] = "<li><a class='dropdown-item ajax ' href='".url("ListingsController@add")."'><i class='ti ti-user-plus me-2'></i> New Listing</a></li>";
							$html[] = "<li><a class='dropdown-item ajax' href='".url("ListingsController@index", null, ["status" => 2])."'><i class='ti ti-home-dollar me-2'></i> Show Sold</a></li>";
							$html[] = "<li><span class='dropdown-item ajax ' data-bs-toggle='offcanvas' href='#filterOffcanvasEnd' role='button' aria-controls='filterOffcanvasEnd'><i class='ti ti-filter me-2'></i> Filter</a></li>";
							$html[] = "<li><span class='dropdown-item ajax btn-download-listings cursor-pointer'><i class='ti ti-download me-2'></i> Download Listings</span></li>";
						$html[] = "</ul>";
					$html[] = "</div>";
				$html[] = "</div>";
			$html[] = "</div>";
			...
			$html[] = "<div class='col-12'>";
				$html[] = "<div class='box-container mb-3'>";
					...
					$html[] = "<div class='search-box'>";
						$html[] = "<input type='text' name='search' id='search' value='' placeholder='Search' data-url='".url("ListingsController@index")."' />";
						$html[] = "<a href='".url("ListingsController@index")."' class='clearFilter'>CLEAR FILTER</a>";
					$html[] = "</div>";
						...
						$html[] = "<div class='table-responsive'>";
							...
							$html[] = "<thead>";
								$html[] = "<tr>";
									...
									$html[] = "<th>Title</th>";
									$html[] = "<th style='width:250px;'>Placement</th>";
									$html[] = "<th class='text-end'>Lot Area</th>";
							...
							for($i=0; $i<count($data['listings']); $i++) { $c++;
								...
								$redirect = "";
								if($data['listings'][$i]['status'] <= 1) {
									$redirect = "onclick='window.location=\"".url("ListingsController@edit",["id" => $data['listings'][$i]['listing_id']])."\"'";
								}

								$html[] = "<tr class='row_listings_".$data['listings'][$i]['listing_id']." listings-table cursor-pointer'>";
									$html[] = "<td $redirect class='align-middle text-center w-1 text-muted'>$c</td>";
									$html[] = "<td $redirect class='align-middle'><div class='avatar' data-thumb-image='".$data['listings'][$i]['thumb_img']."'></div></td>";
									...
									$html[] = "<td $redirect class='align-middle'>";
										...
										if($data['listings'][$i]['is_website'] == 1) {
										...
										if(!empty($placement)) {
											$post_placement = implode(", ", $placement);
										}else {
											$post_placement = "None";
										}

										$html[] = "<span>".$post_placement."</span>";
									$html[] = "</td>";
									$html[] = "<td $redirect class='align-middle text-end'>".$data['listings'][$i]['lot_area']." sqm</td>";
									$html[] = "<td $redirect class='align-middle text-end'>".convertMillions($data['listings'][$i]['price'])."</td>";
									$html[] = "<td $redirect class='align-middle'>".($availability[$data['listings'][$i]['status']])."</td>";
