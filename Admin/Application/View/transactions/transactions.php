                        ...
                        if($data['account']['transaction']) {
                            ...
                            for($i=0; $i<count($data['account']['transaction']); $i++) {
                                $html[] = "<tr>";
                                    ...
                                    $html[] = "<td><a class='d-block text-dark' style='text-decoration: none' href='".url("TransactionsController@invoice", ["account_id" => $data['account']['account_id'], "id" => $data['account']['transaction'][$i]['transaction_id']])."'><span class='d-block text-muted fs-12'>Payment Source</span>".strtoupper($data['account']['transaction'][$i]['payment_source'])."</a></td>";
                                    $html[] = "<td><a class='d-block text-dark' style='text-decoration: none' href='".url("TransactionsController@invoice", ["account_id" => $data['account']['account_id'], "id" => $data['account']['transaction'][$i]['transaction_id']])."'><span class='d-block text-muted fs-12'>Invoice ID</span>".$data['account']['transaction'][$i]['transaction_payment_id']."</a></td>";
