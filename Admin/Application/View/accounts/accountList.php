						...
						$html[] = "<div class='table-responsive'>";
							...
							$html[] = "<thead>";
								$html[] = "<tr>";
									...
									$html[] = "<th>Status</th>";
									$html[] = "<th class='text-center'>Available Listings</th>";
									$html[] = "<th class='text-center'>Sold Listings</th>";
									$html[] = "<th class='text-center'>Expired Listings</th>";
							...
							for($i=0; $i<count($data); $i++) { $c++;
								...
								$html[] = "<tr>";
									...
									$html[] = "<td class='align-middle text-center'>".$data[$i]['total_available']."</td>";
									$html[] = "<td class='align-middle text-center'>".$data[$i]['total_sold']."</td>";
									$html[] = "<td class='align-middle text-center'>".$data[$i]['total_expired']."</td>";
