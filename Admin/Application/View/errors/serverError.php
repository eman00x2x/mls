...
$html[] = "<div class='page page-center mt-5'>";
	$html[] = "<div class='container-tight py-4'>";
		$html[] = "<div class='empty'>";
			...
			$html[] = "<p class='empty-title'>Woah! Somethings not right</p>";
			$html[] = "<p class='empty-subtitle text-secondary'>The administrator is doing something to fix this problem sorry for the inconvenience. Please try again later.</p>";
