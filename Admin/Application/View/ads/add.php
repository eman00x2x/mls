...
$html[] = "<input type='hidden' id='save_url' value='".url("PageAdsController@saveNew")."' />";
				...
				$html[] = "<form id='form' action='' method='POST'>";
					...
					$html[] = "<div class='card mb-3'>";
						$html[] = "<div class='card-header'>";
							$html[] = "<h3 class='card-title text-blue mb-0'>Page Ads Settings</h3>";
						$html[] = "</div>";
						...
						$html[] = "<div class='card-body'>";
							...
							$html[] = "<div class='text-center bg-white mb-5'>";
								...
								$html[] = "<span class='avatar photo-preview mb-1 mb-3 rounded-0' style='background-image: url(".CDN."images/item_default.jpg)'></span>";
                            ...
                            $html[] = "<div class='row justify-content-center'>";
	                            $html[] = "<div class='col-lg-8 col-md-10 col-12'>";
                                        ...
                                        $html[] = "<div class='col-sm-9'>";
                                            $html[] = "<select class='form-select' name='placement' id='placement'>";
                                                ...
                                                foreach($model->placements as $key => $arr) {
                                                    $html[] = "<option value='$key' data-width='".$arr['size']['width']."' data-height='".$arr['size']['height']."'>$key</option>";
                                                }
                                            $html[] = "</select>";
                                        $html[] = "</div>";
                                    $html[] = "</div>";
                                    ...
                                    $html[] = "<div class='row mb-3'>";
                                        ...
                                        $html[] = "<div class='col-sm-9'>";
                                            $html[] = "<input type='url' name='url' id='url' value='' class='form-control' />";
                                        $html[] = "</div>";
                                    $html[] = "</div>";
                                    ...
                                    $html[] = "<div class='row mb-3'>";
                                        ...
                                        $html[] = "<div class='col-sm-9'>";
                                            $html[] = "<input type='date' name='started_at' id='started_at' value='0' class='form-control' />";
                                        $html[] = "</div>";
                                    $html[] = "</div>";
                                    ...
                                    $html[] = "<div class='row mb-3'>";
                                        ...
                                        $html[] = "<div class='col-sm-9'>";
                                            $html[] = "<input type='date' name='ended_at' id='ended_at' value='0' class='form-control' />";
                                        $html[] = "</div>";
                                    $html[] = "</div>";
