...
$html[] = "<input type='hidden' id='save_url' value='".url("TestimonialsController@saveUpdate", ["id" => $data['testimonial_id']])."' />";
					...
					$html[] = "<div class='card mb-3'>";
						...
						$html[] = "<div class='card-body'>";
							...
							$html[] = "<div class='row mb-3'>";
								$html[] = "<label class='text-muted col-sm-3 col-form-label text-end'>Client Name</label>";
							...
							$html[] = "<div class='row mb-3'>";
								...
								$html[] = "<div class='col-sm-9'>";
									$html[] = "<textarea class='form-control' name='content' id='content'>".$data['content']."</textarea>";
								$html[] = "</div>";
							$html[] = "</div>";
