		...
		$html[] = "<form class='card border-0' action='' method='POST'>";
			...
			$html[] = "<div class='card-body p-4 '>";
				...
				$html[] = "<div class='text-wrap'>";
					$html[] = "<p class='text-center mt-4 mb-5'><img src='".CDN."images/logo.png' class='img-fluid mb-3' style='width:350px;' /><br/><b>MLS Administrator Login</b></p>";
				$html[] = "</div>";

				$html[] = "<h5 class='card-title'>Login to your account</h5>";
				$html[] = getMsg();
				...
				$html[] = "<div class='mb-3'>";
					$html[] = "<label class='form-label d-flex justify-content-between'>";
						$html[] = "<span class='d-block'>Password</span>";
						$html[] = "<span class='d-block'><a href='".url("LoginController@forgotPassword")."' class='small text-decoration-none' title='Send Password Reset Link'>I forgot my password</a></span>";
					$html[] = "</label>";
