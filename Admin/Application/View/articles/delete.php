...
if($data) {
	...
	$html[] = "<div class=''>";
		$html[] = "<div class='offcanvas-header'>";
			$html[] = "<h2 class='offcanvas-title' id='offcanvasEndLabel'>Article Deletion</h2>";
		...
		$html[] = "<div class='offcanvas-body'>";
			$html[] = "<div class='response-body'>";
				...
				$html[] = "<p>Are you sure do you want to delete this Article?</p>";
				...
				$html[] = "<div class='d-flex gap-2 align-items-center flex-wrap'>";
					...
					$html[] = "<div class='mb-2'>";
						$html[] = "<span class='small text-muted d-block'>Title</span> ".$data['title']."";
					$html[] = "</div>";

					$html[] = "<div class='mb-3'>";
						$html[] = "<span class='small text-muted d-block'>Created Date</span> ".date("F d, Y",$data['created_at'])."";
					$html[] = "</div>";
				$html[] = "</div>";

				$html[] = "<p>Article will be permanently deleted this action is not reversible. <br/><br/> Are you sure do you want to continue?</p>";
			$html[] = "</div>";
			...
			$html[] = "<div class='btn-delete-controls'>";
				$html[] = "<div class='btn-list'>";
					...
					$html[] = "<span data-url='".url("ArticlesController@delete",["id" => $data['article_id']], ["delete" => "true"])."' data-row='row_article_".$data['article_id']."' class='btn btn-danger btn-continue-delete'><i class='ti ti-trash me-2'></i> Continue Deletion</span>";
				$html[] = "</div>";
			$html[] = "</div>";
