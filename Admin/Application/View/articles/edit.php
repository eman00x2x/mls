...
$html[] = "<input type='hidden' id='save_url' value='".url("ArticlesController@saveUpdate", ["id" => $data['article_id']])."' />";
					...
					$html[] = "<div class='card mb-3'>";
						...
						$html[] = "<div class='card-body'>";
								...
								$html[] = "<div class='col-sm-9'>";
									$html[] = "<select class='form-select' name='category' id='category'>";
										foreach (["News", "Promo", "Tips", "Event"] as $category) {
											$sel = $category == $data['category'] ? "selected" : "";
								...
								$html[] = "<div class='col-sm-9'>";
									$html[] = "<select class='form-select' name='publish' id='publish'>";
										foreach ([0 => "Unpublish", 1 => "Publish"] as $key => $status) {
											$sel = $key == $data['publish'] ? "selected" : "";
											$html[] = "<option value='$key' $sel>".$status."</option>";
										}
									$html[] = "</select>";
								$html[] = "</div>";
							$html[] = "</div>";
							...
							$html[] = "<div class='row mb-3'>";
								...
								$html[] = "<div class='col-sm-9'>";
									$html[] = "<textarea class='form-control' name='content' id='snow-container'>".$data['content']."</textarea>";
								$html[] = "</div>";
							$html[] = "</div>";
