					...
					$html[] = "<div class='card-body'>";
						...
						$html[] = "<div class='mb-3'>";
							$html[] = "<div class='d-flex lh-1 text-reset p-0 btn-view-profile' data-bs-toggle='offcanvas' data-bs-target='#offcanvasEnd' aria-controls='offcanvasEnd' data-url='".url("AccountsController@profilePreview", ["id" => $data['handshake']['requestor_details']['account_id']])."'>";
								...
								$html[] = "<div class='ms-2'>";
									$html[] = "<div class='fw-bold'>".($data['handshake']['requestor_details']['account_name']['nickname'] != "" ? $data['handshake']['requestor_details']['account_name']['nickname'] : $data['handshake']['requestor_details']['account_name']['firstname'])." ".$data['handshake']['requestor_details']['account_name']['lastname']." ".$data['handshake']['requestor_details']['account_name']['suffix']."</div>";
									$html[] = "<div class='mt-1 small'>".($data['handshake']['requestor_details']['account_name']['titles'] != "" ? $data['handshake']['requestor_details']['account_name']['titles'] : $data['handshake']['requestor_details']['profession'])."</div>";
								$html[] = "</div>";
							$html[] = "</div>";
						$html[] = "</div>";
