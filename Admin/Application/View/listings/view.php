					...
					$html[] = "<div class='card-body'>";
						...
						$html[] = "<div class='mb-3'>";
							$html[] = "<div class='d-flex lh-1 text-reset p-0 btn-view-profile' data-bs-toggle='offcanvas' data-bs-target='#offcanvasEnd' aria-controls='offcanvasEnd' data-url='".url("AccountsController@profilePreview", ["id" => $data['handshake']['requestor_details']['account_id']])."'>";
								...
								$html[] = "<div class='ms-2'>";
									$html[] = "<div class='fw-bold'>".((isset($data['handshake']['requestor_details']['account_name']['nickname']) && $data['handshake']['requestor_details']['account_name']['nickname'] != "") ? $data['handshake']['requestor_details']['account_name']['nickname'] : $data['handshake']['requestor_details']['account_name']['firstname'])." ".$data['handshake']['requestor_details']['account_name']['lastname']." ".$data['handshake']['requestor_details']['account_name']['suffix']."</div>";
									$html[] = "<div class='mt-1 small'>".((isset($data['handshake']['requestor_details']['account_name']['titles']) && $data['handshake']['requestor_details']['account_name']['titles'] != "") ? $data['handshake']['requestor_details']['account_name']['titles'] : $data['handshake']['requestor_details']['profession'])."</div>";
								$html[] = "</div>";
							$html[] = "</div>";
						$html[] = "</div>";
						...
						$html[] = "<tr>";
							$html[] = "<td class='cursor-pointer align-middle btn-view-profile' data-bs-toggle='offcanvas' data-bs-target='#offcanvasEnd' aria-controls='offcanvasEnd' data-url='".url("AccountsController@profilePreview", ["id" => $data['handshake_list'][$i]['requestor_details']['account_id']])."' >";
								$html[] = "<div class='p-0 lh-1 d-flex align-items-center'>";
									...
									$html[] = "<div class='ps-2'>";
										$html[] = "<span class='d-block mb-1'>".($data['handshake_list'][$i]['requestor_details']['account_name']['nickname'] != "" ? $data['handshake_list'][$i]['requestor_details']['account_name']['nickname'] : $data['handshake_list'][$i]['requestor_details']['account_name']['firstname'])." ".$data['handshake_list'][$i]['requestor_details']['account_name']['lastname']." ".$data['handshake_list'][$i]['requestor_details']['account_name']['suffix']."</span>";
			...
			$html[] = "<div class='col-md-9 col-12'>";
                $html[] = "<div class='bg-white border px-4 pb-4 '>";
                    ...
                    $html[] = "<div class='mb-2 description ' style='max-height: 300px; overflow: auto;'>";
						...
						$html[] = strip_tags($data['listing']['long_desc'], ["br", "p", "h1", "h2", "h3", "h4", "h5", "h6"]);
					$html[] = "</div>";
