...
if($data) {
	...
	$html[] = "<div class=''>";
		$html[] = "<div class='offcanvas-header'>";
			$html[] = "<h2 class='offcanvas-title' id='offcanvasEndLabel'>Listing Removal</h2>";
		...
		$html[] = "<div class='offcanvas-body'>";
			$html[] = "<div class='response-body'>";
				...
				$html[] = "<p>Listing will be remove. <br/><br/> Are you sure do you want to continue?</p>";
			$html[] = "</div>";
			...
			$html[] = "<div class='btn-delete-controls'>";
				$html[] = "<div class='btn-list'>";
					...
					$html[] = "<span data-url='".url("ListingsController@remove",["id" => $data['listing_id']], ["remove" => "true"])."' data-row='row_listings_".$data['listing_id']."' class='btn btn-danger btn-continue-delete'><i class='ti ti-trash me-2'></i> Continue Removal</span>";
				$html[] = "</div>";
			$html[] = "</div>";
