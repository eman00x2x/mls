													...
													$html[] = "<div class='d-flex py-1 mb-4 align-items-center'>";
														...
														$html[] = "<div class='flex-fill'>";
															$html[] = "<div class='font-weight-medium'>";
																$html[] = ($data['account']['account_name']['nickname'] != "" ? $data['account']['account_name']['nickname'] : $data['account']['account_name']['firstname'])." ".$data['account']['account_name']['lastname']." ".$data['account']['account_name']['suffix'];
															$html[] = "</div>";
															$html[] = "<div class='text-muted'>".($data['account']['account_name']['titles'] != "" ? $data['account']['account_name']['titles'] : $data['profession'])."</div>";
