										...
										$html[] = "<div class='row g-0'>";
											$html[] = "<div class='col-sm-4 col-md-4'>";
												$html[] = "<a href='".url("ListingsController@view", ["name" => $data['listings'][$i]['name']])."'>";
													$html[] = "<div class='avatar avatar-xxxl w-100 rounded-0 border-0' style='position:relative; background-image: url(".$data['listings'][$i]['thumb_img'].")'>";
														$html[] = "<div class='black-gradient'>";
															$html[] = "<div class='bottom-right text-white'>";
																$html[] = "<span class='fs-11'><i class='ti ti-photo fs-14'></i> +".$data['listings'][$i]['total_images']."</span>";
															$html[] = "</div>";

															$html[] = "<div class='bottom-left text-white'>";
																$html[] = "<span class='d-block fw-normal fs-11'><i class='ti ti-map-pin me-1 fs-14'></i> ".$data['listings'][$i]['address']['municipality'].", ".$data['listings'][$i]['address']['province']."</span>";
															$html[] = "</div>";
														$html[] = "</div>";
													$html[] = "</div>";
												$html[] = "</a>";
									...
									$html[] = "<div class='row g-0'>";
										...
										$html[] = "<div class='col-sm-8 col-md-8'>";
											$html[] = "<div class='card-body'>";
												$html[] = "<div class='row'>";
													$html[] = "<div class='col-sm-8 col-md-8 '>";
														$html[] = "<a href='".url("ListingsController@view", ["name" => $data['listings'][$i]['name']])."' style='text-decoration: none;' class='text-dark'><h3 class='mb-0 card-title'>".$data['listings'][$i]['title']."</h3></a>";
													$html[] = "</div>";
