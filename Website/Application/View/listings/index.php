	...
	$html[] = "<div class='container-xl'>";
		...
		$html[] = "<div class='row g-4'>";
					...
					$html[] = "<div class='filter-box'>";
						$html[] = "<div class='d-flex justify-content-between align-items-center'>";
							...
							if($model->page['uri']['offer'] == "for sale") {
								$html[] = "<a href='".url("ListingsController@buy")."' class='fs-12 text-decoration-none'>Clear filter</a>";
							}else {
								$html[] = "<a href='".url("ListingsController@rent")."' class='fs-12 text-decoration-none'>Clear filter</a>";
							}
						...
						$html[] = "<div class='mt-5 sticky-bottom'>";
							$html[] = "<div class='pb-4 ' style='background-color: #f6f8fb'>";
			...
			$html[] = "<div class='col-md-9'>";
				...
				$html[] = "<div class='mb-3 border rounded' style='height:250px; background-color: #ffffe8'> <!-- FEATURED ADS --> </div>";
